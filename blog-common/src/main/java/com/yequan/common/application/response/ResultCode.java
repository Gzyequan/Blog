...
public enum ResultCode {
    ...
    DATA_VALIDATION_ERROR(10005, "数据校验失败"),
    ...
    PERMISSION_DELETE_FAILURE(20022, "删除权限失败"),
    ROLE_CREATE_FAILURE(20023, "新增角色失败"),
    ROLE_DELETE_FAILURE(20024, "删除角色失败"),
    ROLE_UPDATE_FAILURE(20025, "更新角色失败"),
    ROLE_GRANT_PERMISSION_FAILURE(20026,"角色赋权失败"),
    ...
    INTERFACE_REQUEST_REPETITIVE(60008, "重复提交"),
